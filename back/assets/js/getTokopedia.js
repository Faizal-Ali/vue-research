var url_function_tokopedia = 'http://localhost/research/back/kompetitor/ctokopedia'

function get_data_produk_tokopedia(url,url_simpan,url_simpan_toko){
    ...
    .done(function(resp){
        ...
        if(typeof data_prod[0]['data']['pdpGetLayout'] === 'undefined' || data_prod[0]['data']['pdpGetLayout'] === null){
            ...
            $.post(url_simpan, arr_post).done(function(resp){
                ...
                get_data_toko(str_pdp,id_prod,url,url_simpan_toko)
...
function get_data_toko(pdp,id_prod,url,url_simpan){
