var baxiaCommon = function() {
      ...
      , HookBX = function(e) {
        ...
        hookFunction(XHRPrototype, "send", function() {
            ...
            try {
                ...
                throw veryImportantLog("【Request Step】Xhr send error, message: " + n.message + ", stack: " + n.stack),
                Error(n)
            }
        }),
        ...
        hookFunctionAndArguments(XHRPrototype, "open", function() {
            try {
                ...
                throw veryImportantLog("【Request Step】Xhr open error, message: " + n.message + ", stack: " + n.stack),
                Error(n)
            }
        }, !0)
    };
    ...
    var doc$1 = document, loadJS = function(e, t, n) {
        ...
        o.onerror = function(t) {
            log("function:loadJS. msg:" + e + "load error。props：" + JSON.stringify(n)),
            o.onerror = null
        }
        ,
        t) {
        ...
        try {
            ...
            veryImportantLog("【Handler Step】handler error, type: " + e + ", action: " + t.result.action + ", url: " + t.result.url + ", message:" + i.message + ", stack:" + i.stack),
            Error(i)
        }
    };
    function init() {
        ...
        try {
            HookBX$1({
                    ...
                    try {
                        ...
                        throw veryImportantLog("【Response Step】Fetch response done error, message: " + d.message + ", stack: " + d.stack),
                        Error(d)
                    }
                }
            })
